...
$(document).ready(function() {
    ...
    localStorage.setItem('minified',1);
    localStorage.setItem('style','smart-style-1');
    //var _idBody = $('body').attr('id');
    //if(_idBody!='login'){localStorage.setItem('checked',1);}
    ...
    if(localStorage.getItem('minified')==1){$.root_.toggleClass('minified');}
    if(localStorage.getItem('toogleClass')==1){$.root_.toggleClass("hidden-menu");}
    ...
    $('.minifyme').click(function(e) {
        if(!$('body').hasClass("minified")){
            ...
            $(this).effect("highlight", {}, 500);
            localStorage.setItem('minified',0);
        }
        e.preventDefault();
    });
    ...
    $('#hide-menu >:first-child > a').click(function(e) {          
            if($('body').hasClass("hidden-menu")){localStorage.setItem('toogleClass',0);$.root_.toggleClass("hidden-menu");}
            else{localStorage.setItem('toogleClass',1);$.root_.toggleClass("hidden-menu");}
            e.preventDefault();
    });
	...
	$('#refresh').click(function(e) {
		...
		$.SmartMessageBox({
			title : "<i class='fa fa-refresh' style='color:green'></i> Recargar App",
...
// normalizacion de tamaños de navegacion y menu
...
function loadScript(scriptName, callback) {
		...
		if (!jsArray[scriptName]) {
			...
			script.src = 'modules/sistema/html/' + scriptName;
